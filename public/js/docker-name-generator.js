(function() {
  ...
  var RIGHT = {
    ...
    "hoover": "Erna Schneider Hoover revolutionized modern communication by inventing a computerized telephon switching method.",
  ...
  var generate_with_desc = function() {
    ...
    return "<span title='" + RIGHT[name] + "'>" + sample(LEFT).capitalize() + " " + name.capitalize() + "</span>";
  };
